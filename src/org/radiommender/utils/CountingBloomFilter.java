    ...
    implements Set<E>, Serializable
{
    ...
    private int uniqueEntities; // used for this specific implementation. Not part of the CountingBloomFilter! 
     ...
     * 
     * @param expectedElements the typical number of items you expect to be added to the CountingBloomFilter (often
     *            called 'n').
     ...
     * @return This method will always return false
     */
    public boolean reduceCount( E o )
    {
        Random r = new Random( o.hashCode() );
        for ( int x = 0; x < k; x++ )
        {
    ...
    /**
     * Increase the number of unique identities by 1.
     */
    public void increaseUniqueIdentityCount(){
    	this.uniqueEntities++;
    }
    
    /**
     * Decrease the number of unique identities by 1.
     */
    public void decreaseUniqueIdentityCount(){
    	this.uniqueEntities--;
    }
    
    /**
     * Get number of unique identities contained in the Filter.
     * @return
     */
