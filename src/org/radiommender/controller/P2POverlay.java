...
import org.radiommender.controller.overlay.IPeer;
 ...
 * @author nicolas baer
 */
public class P2POverlay implements IPeer{
	// logger
...
//	}
	...
	@Override
	public String getId() {
		return P2POverlay.shortenPeerId(this.peer.getPeerID());
	}

	static String shortenPeerId(Number160 peerID) {
