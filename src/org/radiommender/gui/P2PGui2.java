...
public class P2PGui2 implements Ui
{
    Logger logger = LoggerFactory.getLogger(P2PGui2.class);
    ...
    // module vars
    private P2PChallengeTask application;
    private JFrame frame;
	private String peerId;
    JDialog detailsDialog;

    public P2PGui2(P2PChallengeTask application, boolean askBootstrap, boolean askMusicPath, int position)
    ...
    {
        Icon iconPlay = new ImageIcon( P2PGui2.class.getResource( "/play.png" ) );
        Icon iconSkip = new ImageIcon( P2PGui2.class.getResource( "/skip.png" ) );
        Icon iconStop = new ImageIcon( P2PGui2.class.getResource( "/stop.png" ) );
