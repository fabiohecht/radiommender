...
public class RecommenderSystem {
	 ...
	 * @param localSongs
	 */
	public RecommenderSystem(Overlay overlay, SongHandler songHandler) {
	...
	public void addAffinity(Float key, PeerAddress value){
		...
		for (Entry<Float, PeerAddress> affinityEntry : this.affinityList.entrySet()) {
			affinityEntries.add(new AffinityEntry(Overlay.shortenPeerId(affinityEntry.getValue().getID()), affinityEntry.getKey()));
		}
