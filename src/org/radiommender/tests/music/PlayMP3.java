...
public class PlayMP3 implements Runnable {
	...
	@Override
	public void run() {
		org.radiommender.controller.songhandler.MusicStorageWatcher lib;
				
		try {
				lib = new org.radiommender.controller.songhandler.MusicStorageWatcher(new File("/home/bkey/BlackViolin")).initSongMapping();
